...
public class CoordinatePreTest {
	...
	public void testAdd() {
		...
		Coordinate cadd2 = c1.add(5, -8);
		
		// comprobamos que se suma bien
		assertEquals("x==-65", -65, cadd2.getX());
		assertEquals("y==-10", -10, cadd2.getY());
	...
	public void testAddAll() {
		...
		for (int i=0; i<DIM-2; i++) {	
		   ...
		   assertEquals("Suma de x", caux1.getX(), sumx);
		   assertEquals("Suma de y", caux1.getY(), sumy);
	...
	public void testEqualsObject() {
		...
		Coordinate aux = new Coordinate(0, -70);
		
		assertTrue(aux.equals(lcoor.get(1)));
